...
DEVICE = hx8k
SRC = rtl/top.v rtl/hyper_xface_3V.v rtl/baudgen.v rtl/baudgen_rx.v rtl/uart_rx.v rtl/uart_tx.v 
PORT = /dev/ttyACM0
...
top.txt: $(PIN_DEF) top.json
	nextpnr-ice40 --$(DEVICE) --package tq144:4k --pcf $(PIN_DEF)  --json top.json --asc top.txt --freq 96 
